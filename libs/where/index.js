...
module.exports.getRoute = function (coordinates, callback) {
    getLastPoint((err, data) => {
        ...
        callback(null, `http://static-maps.yandex.ru/1.x/?lang=en-US&ll=${data.lng},${data.lat}&z=13&l=map&size=600,300&pt=${data.lng},${data.lat},flag~${coordinates.lng},${coordinates.lon},flag`);
    });
};